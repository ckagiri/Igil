...
namespace Ligi.Infrastructure.Database
{
    public class AdminDbInitializer :
        CreateDatabaseIfNotExists<AdminDbContext>      // when model is stable
        // DropCreateDatabaseIfModelChanges<AdminDbContext> // when iterating
    {
        ...
        private List<Season> AddSeasons(AdminDbContext context, IList<League> leagues)
        {
        ...
        private void AddTeamsToSeason(AdminDbContext context, IList<League> leagues, IList<Season> seasons, IList<Team> teams)
        {
            ...
            var kplTeams = teams.Take(5).ToList();
            var eplTeams = teams.Skip(5).ToList();

            eplTeams.ForEach(t => eplSeason.Teams.Add(t));
            kplTeams.ForEach(t => kplSeason.Teams.Add(t));
        ...
        private void AddFixturesToSeason(AdminDbContext context, List<League> leagues, List<Season> seasons, List<Team> teams)
        {
            ...
            var eplSeason = context.Seasons.First(s => s.LeagueId == epl && s.Name == "2013 - 2014");
            var eplTeams = teams.Skip(5).ToList();
            var day1 = new LigiWeek().Start().AddDays(-4).AddHours(-3);
            var day2 = new LigiWeek().Start().AddDays(-4);
                                              ...
                                              Odds = new Collection<MatchOdds>
                                                         {
                                                             new MatchOdds
                                                                 {
                                                                     OddsType = OddsType.HangCheng,
                                                                     Handicap = -1
                                                                 },
                                                             new MatchOdds
                                                                 {
                                                                     OddsType = OddsType.TotalGoals,
                                                                     Handicap = 3
                                                                 }
                                                         }
                                          },
                                      ...
                                      new Fixture
                                          {
                                              ...
                                              KickOff = day4,
                                              StartOfWeek = new LigiWeek(day4).Start(),
                                              EndOfWeek = new LigiWeek(day4).End(),
                                              HomeAsianHandicap = -1.75m,
                                              AwayAsianHandicap = 1.75m,
                                              TotalGoalsHandicap = 3.25m,
                                              Odds = new Collection<MatchOdds>
                                                         {
                                                             new MatchOdds
                                                                 {
                                      ...
                                      new Fixture
                                          {
                                              ...
                                              Venue = eplTeams[4].HomeGround,
                                              KickOff = day5,
                                              StartOfWeek = new LigiWeek(day5).Start(),
                                              EndOfWeek = new LigiWeek(day5).End(),
                                              HomeAsianHandicap = 0,
                                              AwayAsianHandicap = 0,
                                              Odds = new Collection<MatchOdds>
                                                         {
                                      ...
                                      new Fixture
                                          {
                                              ...
                                              StartOfWeek = new LigiWeek(day6).Start(),
                                              EndOfWeek = new LigiWeek(day6).End(),
                                              HomeAsianHandicap = -1,
                                              AwayAsianHandicap = -1,
                                          },
                                      new Fixture
