...
namespace Ligi.Core.Utils
{
    public class LigiWeek
    {
        ...
        public LigiWeek(DateTime? moment = null)
        {
    ...
    public class LigiWeeks
    {
        private int _noOfWeeks;
        private DateTime _startDate;
        private DateTime _endDate;
        public LigiWeeks(DateTime startDate, DateTime endDate)
        {
            Init(startDate, endDate);
        }

        public LigiWeeks(int year, int month)
        {
        ...
        private void Init(DateTime startDate, DateTime endDate)
        {
            ...
            _startDate = new LigiWeek(startDate).Start();
            _endDate = new LigiWeek(endDate).End();
        ...
        public List<WeekRange> GetWeeks()
        {
            ...
            var firstWeek = new LigiWeek(_startDate);
